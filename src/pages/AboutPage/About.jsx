        ...
        >
            <div className="max-w-5xl mx-auto text-center">
                <div className="flex flex-col items-center mb-12" data-aos="zoom-in">
                    ...
                    />
                    <h1 className="text-5xl font-extrabold text-[#E67000] dark:text-[#FDBA74] tracking-tight font-inter">
                        ENBAYTECH
                    </h1>
                ...
                <div>
                    <h2
                        className="text-4xl font-bold mb-12 text-[#E67000] dark:text-[#FDBA74] tracking-wide font-inter"
                        data-aos="fade-up"
                    >
                        HİZMETLERİMİZ
                    </h2>
                    <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
                        {services.map((service, idx) => (
                            <div
                                key={service.id}
                                className="bg-white dark:bg-[#3B2415] rounded-xl p-6 shadow-md transition-shadow"
                                data-aos="fade-up"

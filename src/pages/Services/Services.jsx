        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {randomServices.map((service, index) => (
            <motion.div
              ...
              className="cursor-pointer relative flex flex-col md:flex-row items-center bg-color5 dark:bg-color2 rounded-2xl shadow-lg p-6 transition-transform duration-300 hover:scale-[1.03] border border-color3 dark:border-color4"
            >

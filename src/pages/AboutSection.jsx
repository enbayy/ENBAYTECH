...
export const AboutSection = () => {
    ...
    return (
        <section className="container bg-[#fff7ed] dark:bg-[#7c2d12] py-12 font-sans">
            <div className="mx-auto grid md:grid-cols-2 gap-16 items-center">
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-[#0f172a] dark:text-[#e0f2f1] border-b-4 border-[#f97316] inline-block pb-3 mb-6 font-inter">
                        Profesyonel Dijital Çözümler
                    </h2>
                    <p className="text-lg text-[#0f172a] dark:text-[#e0f2f1] leading-relaxed mb-8 font-poppins">
                        <span className="text-[#f97316] dark:text-[#fb923c] font-bold font-inter">ENBAYTECH</span> olarak,
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-md">
                        {services.map(({ icon, text }, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="bg-[#fff7ed] dark:bg-[#7c2d12] border border-gray-200 dark:border-gray-700 rounded-2xl text-[#0f172a] dark:text-[#e0f2f1] font-semibold font-inter shadow-md hover:shadow-lg shadow-gray-700 px-6 py-4 flex items-center gap-3"
                            >

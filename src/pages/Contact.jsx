...
const ContactSection = () => {
    ...
    return (
        <section
            id="contact"
            className="container bg-[#f0fdf4] dark:bg-[#1a1f1c] py-12 text-color1"
        >
            <div data-aos="zoom-in" className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-color4 text-color1 rounded-lg outline-none focus:ring-2 focus:ring-[#10b981]"
                                required
                            />
                        </div>
                        <div>
                    ...
                    <div className="text-center">
                        <button
                            type="submit"
                            className="text-[#0f172a] dark:text-[#e0f2f1] w-[120px] h-[40px] border-2 hover:border-4 rounded-2xl hover:bg-color1 transition duration-300 font-inter"
                        >
                            Gönder
                        </button>
                    </div>

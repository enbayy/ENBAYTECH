    ...
    <section className="container w-full py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 mx-auto">
      <div data-aos="fade-up">
        ...
        >
          ...
          <span className="text-[#E67000] dark:text-[#FF7F00]">Profesyonel</span>{" "}
          <br />
          Tasarımlarla <span className="underline decoration-[#E67000] dark:decoration-[#FF7F00]">Güçlendirin</span>.
        </h1>

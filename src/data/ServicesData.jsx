...
export const services = [
    {
        ...
        icon: <Code className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 2,
        title: "Logo Tasarımı",
        ...
        icon: <PenTool className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 3,
        ...
        icon: <Server className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 4,
        title: "UX/UI Tasarım",
        ...
        icon: <LayoutDashboard className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 5,
        title: "SEO Çalışması",
    ...
    },
    {
        ...
        icon: <RefreshCcw className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 7,
        ...
        icon: <Users className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 8,
        ...
        icon: <Megaphone className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 9,
        ...
        icon: <ShoppingCart className="w-8 h-8 text-[#FF7F00]" />,
    },
    {
        id: 10,
        ...
        icon: <Github className="w-8 h-8 text-[#FF7F00]" />,
    },
];

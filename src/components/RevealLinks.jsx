...
const FlipLink = ({ children, href }) => {
    return (
        <motion.a
            ...
            whileHover="hovered"
            href={href}
            className="relative block overflow-hidden whitespace-nowrap text-5xl font-bold sm:text-6xl md:text-6xl lg:text-7xl tracking-tight leading-tight font-sans"
            style={{
                lineHeight: 1.3,
            }}
        >

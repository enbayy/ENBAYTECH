...
const Footer = () => {
    return (
        <footer className="container bg-white dark:bg-[#000000] py-16">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12">
                    <div className="flex flex-col items-center space-y-5">
                        ...
                        <div className="flex space-x-6">
                            <a
                                ...
                                className="text-[#0f172a] dark:text-[#e0f2f1] hover:text-[#FF7F00] dark:hover:text-[#FF7F00] transition-colors duration-300"
                                aria-label="LinkedIn"
                            >
                                <FaLinkedin size={28} />
                            </a>
                    ...
                    <div className="flex flex-col items-center sm:items-start space-y-4">
                        ...
                        {[
                            ...
                            <div
                                key={service.id}
                                className="flex items-center space-x-2 text-[#0f172a] dark:text-[#e0f2f1] font-poppins hover:text-[#FF7F00] dark:hover:text-[#FF7F00] transition-colors duration-300"
                            >
                    ...
                    <div className="flex flex-col items-center sm:items-start space-y-4">
                        ...
                        <div className="flex items-center space-x-2 text-lg text-[#0f172a] dark:text-[#e0f2f1] font-poppins">
                            <HiOutlineMail size={22} className="text-[#FF7F00]" />
                            <p>info@enbaytech.com</p>
                        </div>

                        <div className="flex items-center space-x-2 text-lg text-[#0f172a] dark:text-[#e0f2f1] font-poppins">
                            <HiOutlinePhone size={22} className="text-[#FF7F00]" />

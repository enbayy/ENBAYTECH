...
export const DrawCircleText = () => {
  return (
    <div className="grid place-content-center bg-[#0F172A] dark:bg-[#0F172A] px-6 py-8 text-yellow-50">
      <h1 className="max-w-2xl text-center text-4xl sm:text-5xl lg:text-6xl font-bold leading-snug">
        ...
        <span className="text-white text-xl sm:text-2xl lg:text-3xl relative font-poppins font-semibold tracking-wider">
        ...
        <span className="text-white text-xl sm:text-2xl lg:text-3xl font-poppins font-semibold tracking-wider">
          işletmenizi ileri taşıyoruz. <br />
        </span>
        <span className="text-white text-lg sm:text-xl lg:text-2xl font-poppins font-medium tracking-wider">
          Teknolojiyi keşfedin, dönüşümü başlatın!
        </span>
      </h1>

...
const BrandLinks = () => {
    return (
        <div className="bg-[#F8FAFC] dark:bg-[#0F172A] px-4 py-12">
...
const ClipPathLinks = () => {
    return (
        <div className="grid grid-cols-4 divide-neutral-900">
            <a href="https://www.facebook.com/engintasarim.com.tr/" target="_blank" rel="noopener noreferrer">
                <LinkBox Icon={SiFacebook} />
            </a>
            <a href="https://www.linkedin.com/company/engintasarim/posts/?feedView=all" target="_blank" rel="noopener noreferrer">
                <LinkBox Icon={SiLinkedin} />
            </a>
            <a href="https://www.instagram.com/engin_tasarim/" target="_blank" rel="noopener noreferrer">
                <LinkBox Icon={SiInstagram} />
            </a>
            <a href="https://twitter.com/engintasarim" target="_blank" rel="noopener noreferrer">
...
const LinkBox = ({ Icon, href }) => {
    ...
    return (
        ...
        >
            ...
            <div ref={scope} style={{ clipPath: BOTTOM_RIGHT_CLIP }} className="absolute inset-0 grid place-content-center bg-[#1E293B] dark:bg-white text-white dark:text-[#1E293B]">

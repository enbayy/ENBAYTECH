                ...
                <div className="flex flex-wrap justify-center md:justify-around items-center gap-4 md:gap-8">
                    <div className="flex items-center gap-2 md:gap-2">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            <p className="text-[#0f172a] dark:text-[#e0f2f1] font-semibold font-poppins">TELEFON:</p>
                            <p className="text-[#0f172a] dark:text-[#e0f2f1] font-semibold font-poppins">0552 231 2086</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 md:gap-2">
                        <FaEnvelope size={20} className="text-[#059669] dark:text-[#10b981]" />
                        <div className="flex gap-2 flex-wrap">
                            <p className="text-[#0f172a] dark:text-[#e0f2f1] font-semibold font-poppins">E-MAİL:</p>
                            <a

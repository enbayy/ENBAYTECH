...
const NavbarUp = () => {
    return (
        <div className="bg-[#fff7ed] dark:bg-[#7c2d12] flex items-center justify-center py-1">
            <div className="container mx-auto px-4 py-2 max-w-screen-lg">
                <div className="flex flex-wrap justify-center md:justify-around items-center gap-4 md:gap-8">
                    <div className="flex items-center gap-2 md:gap-2">
                        <FaPhone size={20} className="text-[#f97316] dark:text-[#fb923c]" />
                    ...
                    <div className="flex items-center gap-2 md:gap-2">
                        <FaEnvelope size={20} className="text-[#f97316] dark:text-[#fb923c]" />
                        <div className="flex gap-2 flex-wrap">

          ...
          <ul className="flex items-center gap-8">
            {MenuLinks.map(({ id, name, link }) => (
              ...
              ${location.pathname === link
                      ? "text-[#E67000] border-b-2 border-[#E67000]"
                      : "text-[#0f172a] dark:text-[#e0f2f1] hover:text-[#FF7F00] dark:hover:text-[#FF7F00]"
                    }
              before:absolute before:bottom-0 before:left-0 before:w-full before:h-[2px]
              before:bg-[#FF7F00] before:scale-x-0 before:origin-right 
